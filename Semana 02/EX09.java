public class EX09 {
    public static void main(String[] args) {
        //Antigamente tinha um programa de televisão onde o apresentador chamava alguém da platéia e fazia o seguinte desafio
        //valendo um prêmio: a pessoa tinha que contar até determinado número, por exemplo de 0 a 30, e a cada múltiplo
        //de um número (por exemplo 3) deveria substituir pela palavra "PIN".
